...
#define EMBER_AF_GP_TRANSLATION_TABLE_UPDATE_OPTION_RESERVED (0xFF00)
#define EMBER_AF_GP_TRANSLATION_TABLE_UPDATE_OPTION_RESERVED_OFFSET (8)
...
#define EMBER_AF_GP_PAIRING_CONFIGURATION_OPTION_RESERVED (0xFC00)
#define EMBER_AF_GP_PAIRING_CONFIGURATION_OPTION_RESERVED_OFFSET (10)
...
#define EMBER_AF_GP_PAIRING_OPTION_FORWARDING_RADIUS_PRESENT (0x020000)
#define EMBER_AF_GP_PAIRING_OPTION_FORWARDING_RADIUS_PRESENT_OFFSET (17)
...
#define EMBER_AF_GP_PROXY_COMMISSIONING_MODE_OPTION_EXIT_MODE (0x0E)
#define EMBER_AF_GP_PROXY_COMMISSIONING_MODE_OPTION_EXIT_MODE_OFFSET (1)
...
#define EMBER_AF_GP_RESPONSE_OPTION_RESERVED (0xF8)
#define EMBER_AF_GP_RESPONSE_OPTION_RESERVED_OFFSET (3)
