...
#if defined(EMBER_COMMAND_INTEPRETER_HAS_DESCRIPTION_FIELD)
static PGM_P PGM emberCommandTableZclIasZoneEnrollCommandArguments[] = {
  "zone type",
  "manufacturer code",
  NULL
};
...
#if defined(EMBER_COMMAND_INTEPRETER_HAS_DESCRIPTION_FIELD)
static PGM_P PGM emberCommandTableZclIasZoneScCommandArguments[] = {
  "zone status",
  "extended status",
  "zone id",
  "delay",
...
static EmberCommandEntry emberCommandTableZclIasZoneCommands[] = {
  emberCommandEntryActionWithDetails("enroll", zclIasZoneEnrollCommand, "vv", "Command description for zoneEnrollRequest", emberCommandTableZclIasZoneEnrollCommandArguments),
  emberCommandEntryActionWithDetails("sc", zclIasZoneScCommand, "vuuv", "Command description for zoneStatusChangeNotification", emberCommandTableZclIasZoneScCommandArguments),
  emberCommandEntryTerminator()
};
...
static EmberCommandEntry emberCommandTableZclCommands[] = {
  ...
  emberCommandEntrySubMenu("ias-zone", emberCommandTableZclIasZoneCommands, ""),
