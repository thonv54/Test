...
/** @brief This command may be used to discover all commands processed (received) by this cluster, including optional or manufacturer specific commands.
 *
...
/** @brief The discover commands received response command is sent in response to a discover commands received command, and is used to discover which commands a particular cluster can process.
 *
...
/** @brief This command may be used to discover all commands which may be generated (sent) by the cluster, including optional or manufacturer specific commands.
 *
...
/** @brief The discover client commands response command is sent in response to a discover client commands command, and is used to discover which commands a particular cluster supports.
 *
...
/** @brief This command is similar to the discover attributes command, but also includes a field to indicate whether the attribute is readable, writeable or reportable.
 *
...
/** @brief This command is sent in response to a discover attribute extended command and is used to determine if attributes are readable, writable or reportable.
 *
 ...
 * @param forwardingRadius uint8_t
...
/** @brief Command description for StepColorTemperatue
 *
 * Cluster: Color Control, Attributes and commands for controlling the color properties of a color-capable light.
 * Command: StepColorTemperatue
 * @param stepMode uint8_t
 * @param stepSize uint16_t
 * @param transitionTime uint16_t
 * @param colorTemperatureMinimum uint16_t
 * @param colorTemperatureMaximum uint16_t
 */
#define emberAfFillCommandColorControlClusterStepColorTemperatue(stepMode, \
                                                                 stepSize, \
                                                                 transitionTime, \
                                                                 colorTemperatureMinimum, \
                                                                 colorTemperatureMaximum) \
